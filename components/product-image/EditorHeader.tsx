...
export const EditorHeader: React.FC<EditorHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col shrink-0 z-[120] transition-colors">
      ...
      {/* Tool Bar */}
      <div className="h-11 bg-slate-50/80 dark:bg-[var(--atlas-bg-panel)] border-b border-slate-100 dark:border-white/[0.04] flex items-center px-2 md:px-6 overflow-x-auto no-scrollbar">
