            ...
            {!isTaskListOpen && (
              ...
              >
                <div className="flex flex-col items-center gap-1.5">
                   ...
                   <span className="text-[10px] font-bold uppercase tracking-widest [writing-mode:vertical-lr] rotate-180 text-slate-500 dark:text-gray-400 group-hover:text-brand-blue">
                     Task List
                   </span>
                </div>
              </motion.button>
  ...
  return (
    <div className="fixed inset-0 z-[1100] flex items-center justify-center p-0 overflow-hidden">
      ...
      <motion.div 
        ...
        className="relative w-full h-full bg-white dark:bg-[var(--atlas-bg-page)] shadow-none flex flex-col transition-colors duration-500 overflow-hidden"
      >
        <ReactFlowProvider>
