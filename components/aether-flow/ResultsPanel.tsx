...
export const ResultsPanel: React.FC<ResultsPanelProps> = ({ 
  ...
  return (
    <div className="w-full bg-slate-50 dark:bg-[var(--atlas-bg-page)] rounded-none p-0 flex flex-col h-full overflow-hidden transition-all duration-300 shadow-sm dark:shadow-none">
      
      <div className="bg-slate-200 dark:bg-[var(--atlas-bg-panel)] shrink-0 border-b border-black/5 dark:border-none">
      ...
      <div className="flex-grow overflow-y-auto p-10 no-scrollbar relative bg-slate-50 dark:bg-[var(--atlas-bg-page)]">
            ...
            >
              {isGenerating ? (
                <div className="h-full flex flex-col items-center justify-center gap-12 text-center">
                  ...
                  <p className="text-2xl font-bold uppercase tracking-[0.5em] text-indigo-600 dark:text-indigo-500 animate-pulse italic">
                ...
                <div className="h-full flex flex-col items-center justify-center gap-10 opacity-10 text-center">
                  ...
                  <p className="text-xl font-bold uppercase tracking-[0.5em] text-slate-900 dark:text-white">CHƯA CÓ KẾT QUẢ SẢN XUẤT</p>
                </div>
              ) : (
                <div className="space-y-12 pb-20">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    {results.map((res) => (
                      <div key={res.id} className="group relative bg-white dark:bg-[var(--atlas-bg-panel)] rounded-none overflow-hidden transition-all border border-black/5 dark:border-none hover:ring-1 hover:ring-indigo-600 dark:hover:ring-indigo-500/50 shadow-sm">
            ...
            >
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 px-1">
                <div className="space-y-3">
                   <div className="flex items-center gap-3 text-indigo-600 dark:text-indigo-500">
                      <h3 className="text-3xl font-bold uppercase tracking-tighter italic text-slate-900 dark:text-white leading-none">THƯ VIỆN QUY TRÌNH</h3>
                   </div>
                   <p className="text-[9px] font-bold text-slate-400 dark:text-zinc-600 uppercase tracking-[0.5em] leading-none italic uppercase">Hệ sinh thái kịch bản AI thế hệ mới</p>
                </div>
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  ...
                  <button 
                    ...
                    className="flex-1 sm:flex-none px-8 py-4 bg-indigo-600 text-white rounded-none text-[10px] font-bold uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-indigo-700 dark:hover:bg-indigo-500 transition-all shadow-md shadow-indigo-600/10"
                  >
              ...
              {loadingTemplates && page === 1 ? (
                <div className="py-40 flex flex-col items-center justify-center gap-6 opacity-30">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-[0.6em] text-slate-900 dark:text-white">ĐANG ĐỒNG BỘ DỮ LIỆU...</p>
                </div>
              ) : (
                <>
