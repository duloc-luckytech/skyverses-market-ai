...
const AetherFlowInterface: React.FC = () => {
  ...
  return (
    <div className="h-full w-full bg-[var(--atlas-bg-page)] dark:bg-[var(--atlas-bg-page)] text-slate-900 dark:text-white font-sans p-4 md:p-6 lg:p-8 flex items-start justify-center overflow-y-auto no-scrollbar relative transition-colors duration-500">
