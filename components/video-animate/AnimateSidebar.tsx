    ...
    <div className="w-full lg:w-[500px] flex flex-col h-full bg-white dark:bg-[var(--atlas-bg-panel)] border border-slate-200 dark:border-white/10 rounded-xl overflow-hidden shadow-atlas-lg relative transition-colors">
      <div className="flex-grow overflow-y-auto no-scrollbar p-8 lg:p-10 space-y-10">
        ...
        <div className="grid grid-cols-2 gap-6 relative z-10">
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-[10px] font-bold text-slate-400 dark:text-gray-500 uppercase tracking-[0.3em]">
              ...
              {props.sourceImg ? (
                ...
                <div className="text-center space-y-2 p-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-[11px] font-bold uppercase tracking-widest text-slate-700 dark:text-white">Tải nhân vật</p>
            ...
            >
              {props.refVideo ? (
                ...
                <div className="text-center space-y-2 p-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-[11px] font-bold uppercase tracking-widest text-slate-700 dark:text-white">Tải Video Mẫu</p>
        ...
        <div className="space-y-6 pt-4 relative z-20">
          <p className="text-[10px] font-bold text-slate-400 dark:text-gray-500 uppercase tracking-[0.4em] text-center italic">Infrastructure & Logic</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* SOURCE SELECTOR */}
            <div className="space-y-2">
              <label className="text-[9px] font-bold uppercase text-gray-400 tracking-widest ml-1 italic flex items-center gap-2">
              ...
              <select 
                ...
                className="w-full bg-slate-50 dark:bg-[var(--atlas-bg-panel)] border border-slate-200 dark:border-white/10 p-3 rounded-xl text-[10px] font-bold uppercase outline-none focus:border-brand-blue transition-colors text-slate-900 dark:text-white appearance-none cursor-pointer shadow-sm"
              >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <button 
                  ...
                  className="w-full bg-slate-50 dark:bg-[var(--atlas-bg-panel)] border border-slate-200 dark:border-white/10 p-3 rounded-xl flex items-center justify-between group hover:border-brand-blue/30 transition-all shadow-sm"
                >
                  <span className="font-bold text-[10px] tracking-tight uppercase italic text-slate-900 dark:text-white truncate pr-4">
        ...
        <div className="grid grid-cols-2 gap-6 pb-4">
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-widest pl-2 italic">Dung lượng / Resolution</label>
            <select 
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-widest pl-2 italic">Tỉ lệ / Ratio</label>
            <select 
      ...
      <div className="p-10 border-t border-black/5 dark:border-white/[0.06] bg-white/80 dark:bg-[var(--atlas-bg-panel)]/80 backdrop-blur-md shrink-0 space-y-4">
        ...
        <div className="text-center">
          <p className="text-[9px] text-slate-400 dark:text-gray-500 font-bold uppercase tracking-[0.4em] italic">
