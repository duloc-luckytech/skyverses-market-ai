            ...
            <div className="hidden lg:flex justify-between items-start">
              <div className="flex items-center gap-4">
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center border shadow-sm transition-colors ${bgAccent} ${borderAccent} ${textAccent}`}>
                  <Icon size={20} className={config.id === 'noel' ? 'animate-spin-slow' : 'animate-pulse'} />
                </div>
                <div>
              ...
              >
                {isUploading ? (
                  ...
                  <>
                    ...
                    <span className="text-[10px] font-black uppercase text-slate-400 dark:text-gray-500 tracking-widest italic text-center">Tải ảnh khuôn mặt cần ghép</span>
                  </>
                )}
