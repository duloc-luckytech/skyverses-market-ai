    ...
    >
            ...
            {accountData ? (
              <div className="space-y-6">
                <div className="space-y-3">
                   <div className="flex justify-between items-center px-1">
                      <label className="text-[10px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-widest italic">YOUR_API_KEY</label>
                ...
                {accountData.apiKey && (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-600 dark:text-amber-500 italic">Security Protocol</p>
              ...
              <div className="py-12 border-2 border-dashed border-slate-200 dark:border-white/10 rounded-[2.5rem] flex flex-col items-center justify-center text-center gap-6 bg-slate-50/50 dark:bg-white/[0.01]">
                 ...
                 <div className="space-y-2 px-8">
                    <h4 className="text-xl font-bold uppercase italic tracking-tight text-slate-800 dark:text-white">Kích hoạt tài khoản</h4>
                 ...
                 {!isAuthenticated && (
                   <p className="text-[10px] font-bold text-orange-500 uppercase flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
         <div className="p-10 bg-white dark:bg-[var(--atlas-bg-panel)] border border-black/5 dark:border-white/5 rounded-[3rem] space-y-6 shadow-sm group hover:border-indigo-500/20 transition-all">
            ...
            <div className="space-y-3">
               <h4 className="text-2xl font-bold uppercase italic tracking-tighter">Bảo mật đa tầng</h4>
         ...
         <div className="p-10 bg-white dark:bg-[var(--atlas-bg-panel)] border border-black/5 dark:border-white/5 rounded-[3rem] space-y-6 shadow-sm group hover:border-brand-blue/20 transition-all">
            ...
            <div className="space-y-3">
               <h4 className="text-2xl font-bold uppercase italic tracking-tighter">Đa nền tảng</h4>
