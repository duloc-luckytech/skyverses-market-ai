...
export const QuotaCard: React.FC<QuotaCardProps> = ({ accountData }) => {
  ...
  return (
    <div className="lg:col-span-4 space-y-8">
      {/* MAIN QUOTA CARD */}
      <div className="p-8 bg-white dark:bg-[var(--atlas-bg-panel)] border border-black/5 dark:border-white/10 rounded-xl space-y-8 shadow-atlas-lg relative overflow-hidden group transition-all duration-500">
         ...
         <div className="space-y-6 relative z-10">
            ...
            <div className="pt-2">
               <button 
                 ...
                 className="w-full py-4 bg-slate-900 dark:bg-white text-white dark:text-black rounded-xl text-center text-[10px] font-bold uppercase tracking-widest shadow-atlas-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 group"
               >
      ...
      {/* TECHNICAL SPECS HUB */}
      <div className="p-8 bg-slate-50 dark:bg-white/[0.02] border border-black/5 dark:border-white/10 rounded-xl space-y-6 shadow-sm">
         <div className="flex items-center gap-3 border-b border-black/5 dark:border-white/[0.06] pb-4">
         ...
         <div className="space-y-3">
            {specs.map(s => (
              <div key={s.l} className="flex justify-between items-center p-3 rounded-xl hover:bg-black/[0.06] dark:hover:bg-white/[0.03] transition-all group border border-transparent hover:border-black/5 dark:hover:border-white/[0.06]">
         ...
         <div className="pt-4 flex flex-col gap-2">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-black/[0.06] dark:bg-white/[0.06] rounded-lg border border-black/5 dark:border-white/[0.06]">
