...
export const FinalCTA: React.FC<FinalCTAProps> = ({ onStartStudio }) => {
  return (
    <section className="py-60 text-center relative overflow-hidden bg-indigo-600 text-white group transition-all duration-700">
      ...
      <div className="max-w-4xl mx-auto space-y-12 relative z-10 px-6">
        <h2 className="text-7xl lg:text-[140px] font-black uppercase tracking-tighter leading-[0.8] italic">Start <br /> <span className="text-slate-900">Animating.</span></h2>
