  ...
  return (
    <div className={`absolute inset-0 z-0 pointer-events-none overflow-hidden ${className ?? ''}`}>
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(112,54,240,0.4) 1px, transparent 1px), linear-gradient(90deg, rgba(112,54,240,0.4) 1px, transparent 1px)',
...
export const HoverCard: React.FC<HoverCardProps> = ({ children, className, glowOnHover = true }) => (
  <motion.div
    whileHover={
      glowOnHover
        ? { y: -4, borderColor: 'rgba(112,54,240,0.25)', boxShadow: '0 8px 32px rgba(112,54,240,0.12)' }
        : { y: -3 }
    }
