      ...
      <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
        ...
        <div className="text-center">
          <p className="text-2xl font-bold text-slate-800 dark:text-white">
            <CountUp value={89420} suffix="+" />
          </p>
          <p className="text-[11px] text-slate-400 dark:text-[#555] mt-0.5 font-medium">Ảnh đã tạo</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] text-slate-400 dark:text-[#555] mt-0.5 font-medium">AI Models</p>
        </div>
