    ...
    <div className="max-w-3xl mx-auto text-center relative z-10">
      <FadeInUp>
        ...
        <h2 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">
          Sẵn sàng tạo ảnh <br />
          <span className="text-brand-blue">bằng AI?</span>
        </h2>
        <p className="text-sm text-slate-500 dark:text-[#666] mb-8 max-w-lg mx-auto leading-relaxed">
          Generate · Edit · Upscale · 22+ AI Models · Xuất 4K/8K · Auto Refund
        </p>
        <motion.button
          onClick={onStartStudio}
          whileHover={{ scale: 1.04, boxShadow: '0 20px 60px rgba(112,54,240,0.25)' }}
          whileTap={{ scale: 0.97 }}
        ...
        <p className="text-[10px] text-slate-400 dark:text-[#555] mt-4 uppercase tracking-widest">
          50 CR / ảnh · Không cần design skills
        </p>
