  ...
  return (
    <section className="py-20 px-6 border-t border-black/[0.06] dark:border-white/[0.04] bg-black/[0.01] dark:bg-white/[0.01]">
      <div className="max-w-[800px] mx-auto">
        ...
        <FadeInUp delay={0.08}>
          <div className="bg-white dark:bg-[var(--atlas-bg-panel)] rounded-xl border border-black/[0.06] dark:border-white/[0.04] px-6 divide-y divide-black/[0.04] dark:divide-white/[0.03]">
            {FAQS.map((faq, i) => (
              <FAQItem
                key={i}
                item={faq}
