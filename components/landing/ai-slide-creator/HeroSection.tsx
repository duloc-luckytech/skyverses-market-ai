...
// CDN hero image — generated by scripts/gen_aislide_landing_images.sh
const CDN_HERO_MAIN = 'https://imagedelivery.net/eCWooK4EUyalJ6a-Nut5cw/18c5d78c-7bc6-4476-dd62-a93d6d752500/public';
                  ...
                  <div className="flex-1 p-3 flex items-center justify-center bg-slate-100 dark:bg-[#0a0a0c]">
                    <AnimatePresence mode="wait">
                      ...
                      >
                        ...
                        <img
                          src={CDN_HERO_MAIN}
                          alt="AI Slide Preview"
                          className="absolute inset-0 w-full h-full object-cover"
                        />
                        {/* Gradient overlay matching active slide accent */}
                        <div className={`absolute inset-0 bg-gradient-to-br ${MOCK_SLIDES[activeSlide].gradient} opacity-60`} />
                        <motion.div
