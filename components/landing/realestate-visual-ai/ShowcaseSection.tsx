...
export const ShowcaseSection: React.FC<ShowcaseSectionProps> = ({ productSlug: _productSlug }) => (
  <section className="py-20 bg-black/[0.02] dark:bg-white/[0.015] overflow-hidden border-t border-black/[0.06] dark:border-white/[0.04]">
    <div className="max-w-[1400px] mx-auto px-6 lg:px-12 mb-10">
      <FadeInUp>
        ...
        <h2 className="text-3xl font-bold mt-2">Hàng nghìn ảnh BĐS từ cộng đồng</h2>
        <p className="text-sm text-slate-500 dark:text-[#666] mt-1">
          Được tạo bởi AI Skyverses — render, staging, banner marketing bất động sản
        </p>
      </FadeInUp>
    </div>
