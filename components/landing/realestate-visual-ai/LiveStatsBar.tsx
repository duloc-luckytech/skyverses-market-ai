  ...
  <div className="py-8 border-y border-black/[0.05] dark:border-white/[0.04] bg-black/[0.01] dark:bg-white/[0.01]">
    <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
      <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
        ...
        <div className="text-center">
          <p className="text-2xl font-bold text-slate-800 dark:text-white">
            <CountUp value={5200} suffix="+" />
          </p>
          <p className="text-[11px] text-slate-400 dark:text-[#555] mt-0.5 font-medium">Dự án BĐS</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] text-slate-400 dark:text-[#555] mt-0.5 font-medium">Phong cách thiết kế</p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-[11px] text-slate-400 dark:text-[#555] mt-0.5 font-medium">Đánh giá TB</p>
        </div>
