        ...
        <div className="mt-auto pt-6 border-t border-black/10 dark:border-white/[0.06]">
           <div className="p-4 bg-brand-blue/5 border border-brand-blue/20 space-y-3">
              <div className="flex items-center gap-3 text-brand-blue">
                 <ShieldCheck size={14} />
                 <span className="text-[9px] font-bold uppercase tracking-widest">Node Quota: 0{credits}/03</span>
              </div>
        ...
        <div className="flex-grow flex flex-col p-6 lg:p-10 overflow-y-auto no-scrollbar relative">
           {items.length === 0 ? (
              <div className="flex-grow flex flex-col items-center justify-center opacity-20 space-y-6">
                 ...
                 <p className="text-[12px] font-bold uppercase tracking-[0.6em]">Awaiting_Batch_Directive</p>
              </div>
           ) : (
              <div className={`grid gap-4 ${batchSize === 4 ? 'grid-cols-2' : batchSize === 9 ? 'grid-cols-3' : 'grid-cols-4'}`}>
                 {items.map((item) => (
                    ...
                    >
                       ...
                       {item.isRefined && (
                          <div className="absolute bottom-2 left-2 px-2 py-0.5 bg-brand-blue text-white text-[7px] font-bold uppercase tracking-widest">Refined_8K</div>
                       )}
                    </div>
                 ))}
              </div>
           ...
           {isGenerating && (
              <div className="absolute inset-0 bg-black/40 backdrop-blur-md z-30 flex flex-col items-center justify-center">
                 ...
                 <p className="text-[10px] font-bold uppercase tracking-[0.5em] text-white animate-pulse italic">Synthesizing_Grid_Matrix...</p>
              </div>
           )}
        </div>
          ...
          {activeItem ? (
             <div className="space-y-8">
                ...
                <div className="space-y-4">
                   <h4 className="text-[10px] font-bold uppercase text-gray-400 tracking-widest">Refinement_Tools</h4>
             ...
             <div className="py-20 text-center border border-dashed border-black/10 dark:border-white/10 opacity-20">
                ...
                <p className="text-[8px] font-bold uppercase tracking-widest">Select Candidate <br /> For Refinement</p>
             </div>
          )}
        </div>
