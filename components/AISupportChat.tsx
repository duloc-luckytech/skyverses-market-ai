...
const AISupportChat: React.FC = () => {
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-[600]">
        <motion.button
        ...
        <AnimatePresence>
          {isOpen && !isFull && (
            <motion.div
              ...
              className="fixed md:absolute bottom-24 right-4 left-4 md:left-auto md:right-0 w-[calc(100vw-2rem)] md:w-[400px] h-[550px] md:h-[600px] max-h-[calc(100dvh-120px)] flex flex-col overflow-hidden bg-white dark:bg-[#0c0c0e] border border-black/5 dark:border-white/10 shadow-[0_30px_90px_rgba(0,0,0,0.2)] rounded-2xl md:rounded-lg z-[700]"
            >
