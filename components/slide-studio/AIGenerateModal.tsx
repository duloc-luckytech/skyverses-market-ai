      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-md bg-white dark:bg-[var(--atlas-bg-panel)] rounded-lg shadow-atlas-lg border border-black/[0.06] dark:border-white/[0.06] overflow-hidden"
          >
            {/* Header */}
