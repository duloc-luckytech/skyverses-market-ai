...
const AIGenerateModal: React.FC<Props> = ({
  ...
  deckTopic, deckStyle, deckLanguage, slideCount, isGenerating,
}) => {
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-black/[0.05] dark:border-white/[0.05]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-white/30">AI sẽ tạo nội dung + ảnh nền cho mỗi slide</p>
                </div>
              </div>
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex items-start gap-2 p-3 rounded-xl bg-brand-blue/[0.05] border border-brand-blue/20">
                ...
                <p className="text-[11px] text-slate-600 dark:text-white/60 leading-relaxed">
                  AI sẽ sinh <strong>{slideCount} slides</strong> kèm nội dung và ảnh nền riêng cho từng slide.
                  Slide hiện ra ngay khi xong — <strong>hoàn toàn miễn phí</strong>.
                </p>
              </div>
            </div>
            ...
            <div className="px-6 pb-5 flex gap-3">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-brand-blue text-white text-[12px] font-bold shadow-lg shadow-brand-blue/20 hover:bg-brand-blue/90 transition-all disabled:opacity-50"
              >
                {isGenerating
