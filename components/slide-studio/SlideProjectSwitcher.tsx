...
// ─── Component ────────────────────────────────────────────────────────────────
export const SlideProjectSwitcher: React.FC<Props> = ({
  projects,
  activeProjectId,
  onSwitch,
  onCreate,
    ...
    <div className="relative">
      ...
      >
        ...
        <span className="flex-1 text-left text-[10px] font-semibold text-slate-700 dark:text-white/80 truncate">
          {activeProject?.name ?? 'Chọn project...'}
        </span>
        <ChevronDown
          size={10}
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="w-[220px] rounded-xl bg-white dark:bg-[var(--atlas-bg-panel)] border border-black/[0.08] dark:border-white/[0.08] shadow-atlas-lg shadow-black/30 overflow-hidden"
            >
              {/* Header */}
              <div className="px-3 py-2 border-b border-black/[0.05] dark:border-white/[0.06]">
                <span className="text-[9px] font-bold uppercase tracking-[0.3em] text-slate-400 dark:text-gray-400">
                  Projects
                </span>
              </div>
...
export default SlideProjectSwitcher;
