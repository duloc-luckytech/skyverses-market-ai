...
export const ImageJobCard: React.FC<ImageJobCardProps> = ({
  ...
  const particles = [
    { x: '15%', y: '15%', color: '#7036F0', delay: 0 },
          ...
          {status === 'submitting' && (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, transparent 0%, rgba(112,54,240,0.06) 50%, transparent 100%)',
          ...
          {status === 'processing' && (
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(rgba(112,54,240,0.15) 1px, transparent 1px), linear-gradient(90deg, rgba(112,54,240,0.15) 1px, transparent 1px)',
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(90deg, transparent, rgba(112,54,240,0.4), rgba(139,92,246,0.4), transparent)',
              ...
              <div className="relative z-10 flex flex-col items-center gap-3">
                <div className={`relative ${isCompact ? 'w-10 h-10' : 'w-14 h-14'}`}>
                  ...
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(112,54,240,0.2), rgba(139,92,246,0.15))',
                      border: '1px solid rgba(112,54,240,0.25)',
                    }}
                  >
                    <Wand2
