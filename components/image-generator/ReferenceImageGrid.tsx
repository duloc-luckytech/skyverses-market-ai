    ...
    <div className="space-y-1.5">
      ...
      {!isExpanded && currentCount === 0 && (
        <div
          onDragOver={handleDragOver}
          onDrop={handleDrop}
          className="flex items-center gap-2 px-2.5 py-2 border border-dashed border-black/[0.06] dark:border-white/[0.06] rounded-lg cursor-pointer hover:border-rose-500/20 transition-all"
