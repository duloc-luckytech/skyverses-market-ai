...
export const EventHistory: React.FC<EventHistoryProps> = ({ results, activeId, onSelect, favorites, onToggleFavorite }) => {
  ...
  return (
    <aside className="hidden lg:flex w-20 xl:w-28 border-l border-black/[0.04] dark:border-white/[0.04] bg-white/60 dark:bg-[var(--atlas-bg-panel)]/60 backdrop-blur-xl flex-col items-center py-6 gap-4 overflow-y-auto no-scrollbar z-50 transition-colors">
