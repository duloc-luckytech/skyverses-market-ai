...
const RealEstateWorkspace: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="h-full w-full flex bg-[#fcfcfd] dark:bg-[#0a0d14] text-slate-900 dark:text-white font-sans overflow-hidden transition-colors duration-500 relative">
      ...
      <div className="flex-grow flex flex-col-reverse lg:flex-row overflow-hidden relative h-full">
        ...
        {/* VIEWPORT */}
        <main className="flex-grow flex flex-col relative bg-[#f8f9fa] dark:bg-[#0a0d14] transition-colors duration-500 overflow-hidden h-full">
