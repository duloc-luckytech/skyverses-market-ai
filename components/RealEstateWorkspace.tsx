...
const RealEstateWorkspace: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div className="h-full w-full flex bg-[var(--atlas-bg-page)] dark:bg-[var(--atlas-bg-page)] text-slate-900 dark:text-white font-sans overflow-hidden transition-colors duration-500 relative">
      ...
      <div className="flex-grow flex flex-col-reverse lg:flex-row overflow-hidden relative h-full">
        ...
        {/* VIEWPORT */}
        <main className="flex-grow flex flex-col relative bg-[var(--atlas-bg-panel-hover)] dark:bg-[var(--atlas-bg-page)] transition-colors duration-500 overflow-hidden h-full">
