      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="w-full sm:max-w-2xl bg-white dark:bg-[var(--atlas-bg-panel)] rounded-t-3xl sm:rounded-lg border border-black/[0.06] dark:border-white/[0.06] shadow-atlas-lg flex flex-col overflow-hidden max-h-[90dvh]"
          >
            {/* Header */}
