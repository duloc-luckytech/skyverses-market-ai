         ...
         <div className="p-10 bg-white/[0.01] border border-white/5 space-y-12 rounded-2xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               <div className="space-y-4">
                  <label className="text-[11px] font-bold uppercase text-gray-400">SỐ LẦN THỬ LẠI KHI LỖI</label>
               ...
               <div className="space-y-4">
                  <label className="text-[11px] font-bold uppercase text-gray-400">SỐ LUỒNG TỐI ĐA</label>
                  <div className="flex items-center gap-4">
