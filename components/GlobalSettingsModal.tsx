        ...
        >
          ...
          <div className="flex-grow overflow-y-auto no-scrollbar p-5 md:p-8 space-y-6 md:space-y-10">
            ...
            <div className="space-y-3">
              <label className="text-[9px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-[0.2em] px-1">Models</label>
            ...
            {/* Resolution */}
            <div className="space-y-3">
              <label className="text-[9px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-[0.2em] px-1">Resolution</label>
            ...
            {/* Aspect Ratio */}
            <div className="space-y-3">
              <label className="text-[9px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-[0.2em] px-1">Aspect Ratio</label>
            ...
            {/* Duration */}
            <div className="space-y-3">
              <label className="text-[9px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-[0.2em] px-1">Duration</label>
            ...
            <div className="space-y-4 md:space-y-6 pt-2">
               <div className="flex items-center justify-between group gap-4">
                  <div className="space-y-0.5">
                    <p className="text-[11px] md:text-[12px] font-bold uppercase tracking-widest text-slate-800 dark:text-white">Generate with Credits</p>
               ...
               <div className="flex items-center justify-between group gap-4">
                  <p className="text-[11px] md:text-[12px] font-bold uppercase tracking-widest text-slate-800 dark:text-white">Enhance Prompt</p>
                  <Switch active={switches.enhance} onChange={() => setSwitches({...switches, enhance: !switches.enhance})} />
               </div>

               <div className="flex items-center justify-between group gap-4">
                  <p className="text-[11px] md:text-[12px] font-bold uppercase tracking-widest text-slate-800 dark:text-white">Smart Multi-shot</p>
