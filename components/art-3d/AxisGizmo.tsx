        ...
        >
          ...
          <div style={{ transform: 'rotateY(90deg) translateZ(40px)', transformStyle: 'preserve-3d' }} className="absolute">
            <button 
              ...
              className="pointer-events-auto w-6 h-6 rounded-full bg-red-500 border-2 border-white flex items-center justify-center text-[10px] font-bold text-white shadow-lg hover:scale-125 transition-transform"
            >X</button>
          ...
          <div style={{ transform: 'rotateX(90deg) translateZ(40px)', transformStyle: 'preserve-3d' }} className="absolute">
            <button 
              onClick={() => onSnap('TOP')}
              className="pointer-events-auto w-6 h-6 rounded-full bg-[#dfff1a] border-2 border-white flex items-center justify-center text-[10px] font-bold text-black shadow-lg hover:scale-125 transition-transform"
            >Y</button>
          ...
          <div style={{ transform: 'translateZ(40px)', transformStyle: 'preserve-3d' }} className="absolute">
            <button 
              ...
              className="pointer-events-auto w-6 h-6 rounded-full bg-blue-500 border-2 border-white flex items-center justify-center text-[10px] font-bold text-white shadow-lg hover:scale-125 transition-transform"
            >Z</button>
