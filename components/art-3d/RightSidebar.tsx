                ...
                {filteredAssets.map((asset: any) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-2 left-2 right-2">
                        <p className="text-[8px] font-bold uppercase text-white italic truncate">{asset.name}</p>
                    </div>
        ...
        {activeMainTab === 'Property' && (
          <div className="flex-grow overflow-y-auto no-scrollbar p-6 space-y-8 animate-in fade-in slide-in-from-right-2">
            ...
            <div className="space-y-6 pt-2">
              <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-purple-400 italic">PBR Override</p>
