  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed inset-0 z-[700] flex flex-col bg-white dark:bg-[var(--atlas-bg-page)] text-slate-900 dark:text-white font-sans overflow-hidden transition-colors duration-500"
      >
              ...
              {allAssets.map((asset) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/70 to-transparent py-0.5">
                    <span className="text-[5px] md:text-[6px] font-bold text-white uppercase text-center block tracking-tighter">
                      {asset.label}
                    </span>
                  </div>
                </button>
