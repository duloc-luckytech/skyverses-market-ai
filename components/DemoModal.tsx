  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10">
      ...
      <div className="relative w-full max-w-6xl bg-brand-gray border border-white/10 shadow-[0_0_100px_rgba(201, 168, 76,0.2)] flex flex-col max-h-[90vh] animate-in zoom-in-95 slide-in-from-bottom-10 duration-500">
        ...
        {/* Header */}
        <div className="flex justify-between items-center px-8 py-6 border-b border-white/[0.06] bg-black/40">
        ...
        {/* Content */}
        <div className="flex-grow overflow-hidden flex flex-col bg-[var(--atlas-bg-page)]">
          <DemoInterface type={type} />
        </div>
        
        {/* Footer Info */}
        <div className="px-8 py-4 bg-black border-t border-white/[0.06] flex justify-between items-center text-[9px] font-bold uppercase tracking-widest text-white/20">
