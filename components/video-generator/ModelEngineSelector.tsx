  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-4">
        ...
        {/* Model Selection */}
        <div className="space-y-3">
          <label className="text-[10px] font-bold uppercase text-slate-400 dark:text-gray-500 tracking-widest pl-1">
            Model Engine
          </label>
          <div className="relative">
            <select 
              ...
              className="w-full bg-white dark:bg-[var(--atlas-bg-panel)] border border-slate-200 dark:border-white/10 p-3 rounded-lg text-[11px] font-bold uppercase outline-none appearance-none focus:border-purple-500 text-slate-800 dark:text-white transition-colors cursor-pointer"
            >
