...
interface TetShowcaseProps {
  images: any[];
  loading: boolean;
}

export const TetShowcase: React.FC<TetShowcaseProps> = ({ images, loading }) => {
  return (
      ...
      <div className="absolute inset-0 overflow-hidden mask-fade-vertical">
        {loading ? (
          <div className="h-full flex flex-col items-center justify-center gap-4 opacity-20">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-900 dark:text-white">Đang tải kịch bản xuân...</span>
          </div>
        ) : (
            ...
            {[...images, ...images].map((img, idx) => (
              ...
              >
                ...
                <div className="absolute bottom-6 left-6 right-6">
                   <span className="text-[8px] font-black uppercase text-amber-400 tracking-widest block mb-2">Ảnh Tết AI</span>
