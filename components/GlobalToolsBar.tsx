    ...
    <>
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 z-[300] w-full max-w-4xl px-4 pb-4 pointer-events-none">
        <motion.div 
          ...
          className="mx-auto pointer-events-auto relative rounded-[2.5rem] shadow-[0_40px_100px_rgba(0,0,0,0.1)] dark:shadow-[0_40px_100px_rgba(0,0,0,0.6)] overflow-hidden p-[1.5px] transition-colors group"
        >
          {/* RUNNING BORDER ANIMATION LAYER */}
          <div className="absolute inset-[-500%] animate-[spin_6s_linear_infinite] bg-[conic-gradient(from_0deg,transparent_0deg,transparent_320deg,#0090ff_360deg)] opacity-40 group-hover:opacity-100 transition-opacity pointer-events-none"></div>
          
          {/* INNER CONTENT LAYER */}
          <div className="relative w-full h-full bg-white/90 dark:bg-[#0d0d0f]/95 backdrop-blur-3xl rounded-[2.5rem] overflow-hidden transition-colors">
