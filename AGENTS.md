...
| Đổi tech stack (thêm lib lớn, đổi version Vite/React) | `AGENTS.md` (file này) |
...
**Regen toàn bộ source map:** bảo Codex *"regenerate docs/source-map"* (chỉ chạy khi refactor lớn).
