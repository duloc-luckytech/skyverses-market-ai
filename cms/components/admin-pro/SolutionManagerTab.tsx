...
interface SolutionManagerTabProps {
...
export const SolutionManagerTab: React.FC<SolutionManagerTabProps> = ({ 
      ...
      <table className="w-full text-left border-collapse font-mono">
        <thead>
          <tr className="bg-black/5 dark:bg-white/5 text-[9px] font-black uppercase tracking-widest text-gray-500">
            <th className="px-8 py-6">Đường dẫn định danh (Slug)</th>
            <th className="px-8 py-6">Trạng thái đồng bộ</th>
              ...
              <td className="px-8 py-6">
                {asynced ? (
                  <div className="flex items-center gap-2 text-emerald-500">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest">Đã đồng bộ</span>
                    <Check size={12} strokeWidth={4} />
                  </div>
                ) : (
                  <div className="flex items-center gap-3 text-orange-500">
                    <span className="text-[9px] font-black uppercase tracking-widest opacity-60 italic">Chỉ Local</span>
              ...
              <td className="px-8 py-6">
                <div className="flex flex-wrap gap-1.5 max-w-[220px]">
                   {sol.homeBlocks && sol.homeBlocks.length > 0 ? (
                     ...
                     <span className="text-[8px] font-bold text-gray-300 dark:text-gray-800 uppercase italic">Chưa gán</span>
                   )}
                </div>
              </td>
              <td className="px-8 py-6">
                 <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                       {sol.isFree ? (
                          <span className="text-[9px] font-black text-emerald-500 uppercase tracking-widest bg-emerald-500/5 px-2 py-0.5 rounded border border-emerald-500/20">Miễn phí</span>
                       ) : (
