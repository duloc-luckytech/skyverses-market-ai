...
const VoiceDesignAI: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[var(--atlas-bg-panel)] min-h-screen text-slate-900 dark:text-[#E6E8EE] font-sans selection:bg-[#7C7CFF]/30 overflow-x-hidden pt-20 transition-colors duration-500">
            ...
            >
              ...
              <div className="flex items-center justify-between p-4 md:px-8 border-b border-slate-200 dark:border-white/[0.06] bg-slate-50/50 dark:bg-black/40 shrink-0">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-xs font-bold uppercase tracking-[0.3em] italic text-slate-800 dark:text-white">Voice_Design_Studio</h2>
                ...
                <div className="flex items-center gap-6">
                   <div className="hidden md:flex items-center gap-6 text-[8px] font-bold uppercase tracking-widest text-slate-400 dark:text-gray-500 italic">
        ...
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center relative z-10">
          <div className="lg:col-span-5 space-y-10">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#7C7CFF]/10 border border-[#7C7CFF]/20 text-[#7C7CFF] text-[10px] font-bold uppercase tracking-[0.3em] italic"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              <button 
                ...
                className="bg-[#7C7CFF] text-white px-12 py-6 rounded-sm text-xs font-bold uppercase tracking-[0.4em] shadow-[0_20px_50px_rgba(124,124,255,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4 group"
              >
      ...
      <section className="py-40 border-y border-slate-200 dark:border-white/[0.06] relative bg-slate-50 dark:bg-[var(--atlas-bg-panel)] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center space-y-4 mb-24">
             ...
             <p className="text-slate-400 dark:text-[#9AA0B2] uppercase text-[10px] font-bold tracking-[0.5em]">Simple Interaction // Neural Results</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="p-12 bg-white dark:bg-white/[0.06] border border-slate-200 dark:border-white/10 rounded-sm relative group hover:border-[#7C7CFF]/30 transition-all shadow-sm hover:shadow-xl">
                ...
                <h4 className="text-2xl font-bold uppercase italic tracking-tight mb-4 text-slate-800 dark:text-white">{step.t}</h4>
              ...
              {[
                ...
                <div key={i} className="p-16 bg-white dark:bg-[var(--atlas-bg-panel)] space-y-8 group hover:bg-[#7C7CFF]/[0.02] transition-all duration-500 border-r border-slate-100 dark:border-white/[0.06] last:border-r-0">
                   ...
                   <div className="space-y-3">
                      <h4 className="text-2xl font-bold uppercase tracking-tighter italic text-slate-800 dark:text-white">{f.t}</h4>
      ...
      <section className="py-40 bg-white dark:bg-[var(--atlas-bg-panel)] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
           <div className="text-center space-y-4 mb-24">
              <h2 className="text-4xl lg:text-6xl font-bold uppercase italic tracking-tighter leading-none text-slate-900 dark:text-white">Designed for <br /><span className="text-[#7C7CFF]">Every Frontier.</span></h2>
           </div>
      ...
      <section className="py-40 bg-slate-50 dark:bg-[var(--atlas-bg-panel)] text-center border-y border-slate-200 dark:border-white/[0.06] transition-colors">
         <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="flex flex-wrap justify-center gap-16 opacity-30 dark:opacity-30 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-700">
               <span className="text-2xl font-bold italic tracking-tighter text-slate-800 dark:text-slate-100">YOUTUBE</span>
               <span className="text-2xl font-bold italic tracking-tighter text-slate-800 dark:text-slate-100">SPOTIFY</span>
               <span className="text-2xl font-bold italic tracking-tighter text-slate-800 dark:text-slate-100">TWITCH</span>
               <span className="text-2xl font-bold italic tracking-tighter text-slate-800 dark:text-slate-100">AUDIBLE</span>
            </div>
            <div className="pt-12">
               ...
               <p className="mt-6 text-[10px] font-bold uppercase tracking-[0.4em] text-[#7C7CFF]">Chief Creative, Apex Studios</p>
            </div>
         </div>
      </section>
      ...
      <section className="py-40 bg-white dark:bg-[var(--atlas-bg-panel)] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center space-y-24">
           <h2 className="text-4xl lg:text-6xl font-bold uppercase tracking-tighter italic text-slate-900 dark:text-slate-100">Investment Tiers</h2>
      ...
      <section className="py-60 text-center relative overflow-hidden bg-[#7C7CFF]">
        <div className="absolute inset-0 opacity-10 flex flex-wrap gap-4 p-8 pointer-events-none text-[220px] font-bold text-white leading-none tracking-tighter select-none italic">
          VOICE VOICE VOICE VOICE
        </div>
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
           <h2 className="text-7xl lg:text-[130px] font-bold uppercase tracking-tighter leading-[0.8] italic text-white">Start Designing <br /> AI Voices Today.</h2>
           <div className="flex flex-col sm:flex-row items-center justify-center gap-10 pt-10">
            ...
            <button className="bg-white/10 text-white border border-white/20 px-20 py-8 rounded-sm text-sm font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all">
              View Documentation
            </button>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-12 text-[10px] font-bold uppercase tracking-widest">
           <div className="flex flex-col items-center md:items-start gap-4">
              <div className="flex items-center gap-4 text-slate-900 dark:text-slate-100">
                 <span className="text-lg tracking-tighter italic font-bold uppercase">Voice Design AI</span>
              </div>
