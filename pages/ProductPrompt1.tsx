...
import PromptArchitectInterface from '../components/PromptArchitectInterface';
import { 
  ...
  PackageCheck, Workflow
} from 'lucide-react';

const ProductPrompt1 = () => {
  const solution = SOLUTIONS.find(s => s.slug === 'prompt-architect-core');
  ...
  return (
    <div className="pt-24 bg-white dark:bg-black min-h-screen text-black dark:text-white font-sans selection:bg-brand-blue/30 overflow-x-hidden transition-colors duration-500 pb-32">
        ...
        <div className="fixed inset-0 z-[250] bg-white/98 dark:bg-black/98 flex flex-col animate-in fade-in duration-300">
          <div className="h-16 border-b border-black/10 dark:border-white/5 bg-white/80 dark:bg-black/80 backdrop-blur-xl flex items-center justify-between px-8 shrink-0">
             <div className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.4em] text-gray-600 dark:text-white/70">Orchestrator_Terminal // Prompt_Architect_v1.2</span>
             </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-2">
                ...
                <div className="px-3 py-1 bg-brand-blue/10 border border-brand-blue/30 rounded-sm w-fit">
                   <span className="text-[9px] font-black text-brand-blue uppercase tracking-widest">Logic_Orchestration</span>
                </div>
              </div>
              <p className="text-gray-500 dark:text-gray-400 text-xl font-medium max-w-2xl leading-relaxed italic">"Turn prompts into production-grade assets with structured logic and version control."</p>
            </div>
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-black text-gray-400 dark:text-white/40 uppercase tracking-widest">4.9 (420 TEAMS_INTEGRATED)</span>
              </div>
              <div className="flex items-center gap-3">
                 <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                 <span className="text-[10px] font-bold text-gray-400 dark:text-gray-700 uppercase tracking-widest">Compiler Active</span>
              </div>
            </div>
          </div>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                 <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex justify-center gap-4">
                       <Braces className="w-12 h-12 text-brand-blue" />
                       <Workflow className="w-12 h-12 text-black/10 dark:text-white/10" />
                    </div>
                    <div className="space-y-4">
                       <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none italic text-black dark:text-white">Orchestrate <br /> <span className="text-brand-blue">Semantic Logic</span></h2>
                       <p className="text-gray-600 dark:text-gray-500 text-sm uppercase font-black tracking-widest">Enterprise-Grade Prompt Engineering Engine</p>
                    </div>
                    <button 
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic flex items-center gap-4">
                <div className="w-12 h-[2px] bg-brand-blue"></div> Semantic_Philosophy
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed font-medium">
                Prompt Architect Core treats prompt engineering as a rigorous software development practice. By segmenting logic into structured nodes and implementing model-specific syntax adapters, we eliminate the chaos of "prompt guessing." This engine provides AI teams with a deterministic framework to build, test, and deploy semantic instructions at enterprise scale.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 rounded-sm">
                 ...
                 <h3 className="text-xl font-black uppercase tracking-tighter">Primary_Flows</h3>
                 <ul className="space-y-3">
                   {["Multi-modal asset orchestration.", "Cross-model syntax translation.", "Runtime variable injection loops.", "Team-wide prompt standardization."].map(item => (
              ...
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 flex flex-col justify-center rounded-sm">
                 ...
                 <p className="text-sm text-gray-500 dark:text-gray-600 leading-relaxed font-medium uppercase tracking-widest">
                   H100 Parallel Compilers · AES-256 Vaulting · SDK/API Ready · JSON Production Ready
                 </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-4">
              {solution.features.map((f: any, i: number) => {
                ...
                return (
                  <div key={i} className="p-5 border border-black/10 dark:border-white/10 hover:border-brand-blue/30 transition-all group rounded-sm">
                     <h4 className="text-[12px] font-black uppercase text-black dark:text-white mb-1 group-hover:text-brand-blue">{title}</h4>
                     <p className="text-[11px] text-gray-500 dark:text-gray-600 font-medium leading-relaxed">{desc || ''}</p>
                  </div>
                );
              })}
            </div>
        ...
        <section className="mb-32 py-20 border-y border-black/10 dark:border-white/5">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="max-w-xl space-y-6 text-center lg:text-left">
              ...
              <p className="text-gray-500 dark:text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-widest">Advanced orchestration of reasoning models for syntax mastery.</p>
            </div>
           ...
           <div className="bg-gradient-to-br from-brand-blue/10 to-transparent border border-brand-blue/20 p-12 lg:p-24 relative overflow-hidden group rounded-sm shadow-xl">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                 <div className="space-y-8 max-w-2xl text-center lg:text-left">
                    <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.8] text-black dark:text-white">Orchestrate Your <br /> <span className="text-brand-blue italic">AI Fleet.</span></h2>
                    <p className="text-gray-600 dark:text-gray-500 text-lg leading-relaxed font-medium">
                       Deploy a dedicated Prompt Architect Node for your team. Industrial-scale orchestration with custom API endpoints and private logic vaulting.
                    </p>
                 </div>
