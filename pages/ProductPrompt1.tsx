          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-2">
                ...
                <div className="px-3 py-1 bg-brand-blue/10 border border-brand-blue/30 rounded-sm w-fit">
                   <span className="text-[9px] font-bold text-brand-blue uppercase tracking-widest">Logic_Orchestration</span>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-bold text-gray-400 dark:text-white/40 uppercase tracking-widest">4.9 (420 TEAMS_INTEGRATED)</span>
              </div>
           ...
           <div className="aspect-[21/9] w-full bg-gray-100 dark:bg-[var(--atlas-bg-page)] border border-black/5 dark:border-white/[0.06] overflow-hidden relative shadow-atlas-lg rounded-sm">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                 <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="space-y-4">
                       <h2 className="text-4xl lg:text-5xl font-bold uppercase tracking-tighter leading-none italic text-black dark:text-white">Orchestrate <br /> <span className="text-brand-blue">Semantic Logic</span></h2>
                       <p className="text-gray-600 dark:text-gray-500 text-sm uppercase font-bold tracking-widest">Enterprise-Grade Prompt Engineering Engine</p>
                    </div>
                    <button 
              ...
              {solution.features.map((f: any, i: number) => {
                ...
                return (
                  <div key={i} className="p-5 border border-black/10 dark:border-white/10 hover:border-brand-blue/30 transition-all group rounded-sm">
                     <h4 className="text-[12px] font-bold uppercase text-black dark:text-white mb-1 group-hover:text-brand-blue">{title}</h4>
           ...
           <div className="bg-gradient-to-br from-brand-blue/10 to-transparent border border-brand-blue/20 p-12 lg:p-24 relative overflow-hidden group rounded-sm shadow-atlas-lg">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                 <div className="space-y-8 max-w-2xl text-center lg:text-left">
                    <h2 className="text-5xl lg:text-7xl font-bold uppercase tracking-tighter leading-[0.8] text-black dark:text-white">Orchestrate Your <br /> <span className="text-brand-blue italic">AI Fleet.</span></h2>
