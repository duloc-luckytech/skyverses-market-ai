...
const SettingsPage = () => {
  ...
  return (
    <div className="pt-24 md:pt-28 pb-32 min-h-screen bg-[var(--atlas-bg-panel-hover)] dark:bg-[var(--atlas-bg-page)] text-black dark:text-white transition-colors duration-500">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          {/* RIGHT CONTENT */}
          <main className="flex-grow bg-white dark:bg-[var(--atlas-bg-page)] border border-black/[0.04] dark:border-white/[0.04] rounded-2xl overflow-hidden min-h-[600px] shadow-sm">
            {/* Tab Header Bar */}
            {activeItem && (
