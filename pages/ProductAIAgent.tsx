...
import { 
  ...
  Workflow, LayoutGrid, Database, Lock
} from 'lucide-react';

const ProductAIAgent = () => {
  const solution = SOLUTIONS.find(s => s.slug === 'aether-flow-orchestrator');
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-6">
              ...
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[10px] font-bold text-gray-400 dark:text-gray-700 uppercase tracking-widest">Orchestrator Online</span>
              </div>
            </div>
          </div>
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                 <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex justify-center gap-4">
                       <Workflow className="w-12 h-12 text-brand-blue" />
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed font-medium">
                Aether Flow Orchestrator (AFO) is a paradigm shift in AI product validation. By executing neural pipelines entirely on the client-side using direct Gemini API integration, AFO allows technical teams to design, iterate, and validate complex workflows without building backend infrastructure. It provides a studio-grade environment for high-speed AI prototyping and sales demonstrations.
              </p>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-4">
              {[
                ...
                { title: "Contextual Injection", desc: "Pass data between nodes automatically in-browser." },
                { title: "Parallel Batching", desc: "Orchestrate multiple Gemini calls simultaneously." },
           ...
           <div className="bg-gradient-to-br from-brand-blue/10 to-transparent border border-brand-blue/20 p-12 lg:p-24 relative overflow-hidden group rounded-sm shadow-atlas-lg">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                 ...
                 <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-auto">
                    <Link to="/booking" className="btn-sky-primary px-16 py-8 text-[11px] uppercase tracking-[0.4em] text-center shadow-atlas-lg transition-all">Request_Pilot_Demo</Link>
