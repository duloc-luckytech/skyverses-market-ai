...
import NexusStudioInterface from '../../components/NexusStudioInterface';
import { 
...
const Product2Video = () => {
  const solution = SOLUTIONS.find(s => s.slug === 'nexus-video-studio');
  ...
  const showcaseVideos = [
    { url: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&q=80&w=1200", label: "COMMERCIAL_01: PRODUCT_ELEGANCE" },
    { url: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&q=80&w=1200", label: "COMMERCIAL_02: BRAND_IDENTITY" },
    { url: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=1200", label: "COMMERCIAL_03: TECH_NARRATIVE" },
    { url: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=1200", label: "COMMERCIAL_04: LIFESTYLE_DYNAMIC" }
  ];
        ...
        <div className="fixed inset-0 z-[250] bg-white/98 dark:bg-black/98 flex flex-col animate-in fade-in duration-300">
          <div className="h-16 border-b border-black/10 dark:border-white/5 bg-white/80 dark:bg-black/80 backdrop-blur-xl flex items-center justify-between px-8 shrink-0">
             <div className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.4em] text-gray-600 dark:text-white/70">Nexus_Studio // Production_Alpha</span>
             </div>
      ...
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-2">
                ...
                <div className="px-3 py-1 bg-brand-blue/10 border border-brand-blue/30 rounded-sm w-fit">
                   <span className="text-[9px] font-black text-brand-blue uppercase tracking-widest">Enterprise_Commercial</span>
                </div>
              </div>
              <p className="text-gray-500 dark:text-gray-400 text-xl font-medium max-w-2xl leading-relaxed italic">"Automated high-fidelity production for commercial brand teams."</p>
            </div>
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-black text-gray-400 dark:text-white/40 uppercase tracking-widest">4.9 (1,200 BRANDS_SCALED)</span>
              </div>
              <div className="flex items-center gap-3">
                 <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                 <span className="text-[10px] font-bold text-gray-400 dark:text-gray-700 uppercase tracking-widest">Studio Online</span>
              </div>
            </div>
          </div>
        ...
        <section className="mb-24 relative group">
           <div className="aspect-[21/9] w-full bg-gray-100 dark:bg-[#080808] border border-black/5 dark:border-white/5 overflow-hidden relative shadow-2xl rounded-sm">
              <img src={solution.imageUrl} className="w-full h-full object-cover grayscale opacity-40 group-hover:opacity-60 transition-all duration-1000 group-hover:scale-105" alt="Nexus Studio Hub" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                 <div className="max-w-3xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    <div className="flex justify-center gap-4">
                       <Clapperboard className="w-12 h-12 text-brand-blue" />
                       <MonitorPlay className="w-12 h-12 text-black/10 dark:text-white/10" />
                    </div>
                    <div className="space-y-4">
                       <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none italic text-black dark:text-white">Commercial <br /> <span className="text-brand-blue">Motion Synthesis</span></h2>
                       <p className="text-gray-600 dark:text-gray-500 text-sm uppercase font-black tracking-widest">Brand-safe production engine for industrial teams</p>
                    </div>
                    <button 
        ...
        <section className="mb-32 grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic flex items-center gap-4">
                <div className="w-12 h-[2px] bg-brand-blue"></div> Brand_Safe_Philosophy
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed font-medium">
                Nexus Video Studio is designed for commercial teams that require absolute control over visual consistency and brand integrity. It utilizes a deterministic motion engine that allows for precise camera paths and lighting setups, ensuring that every generated asset fits seamlessly into a professional marketing campaign.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 rounded-sm">
                 ...
                 <h3 className="text-xl font-black uppercase tracking-tighter">Commercial_Sectors</h3>
                 <ul className="space-y-3">
                   {["Product showcase & lifestyle ads.", "Corporate brand storytelling.", "High-frequency social media assets.", "Retail visualization loops."].map(item => (
              ...
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 flex flex-col justify-center rounded-sm">
                 ...
                 <p className="text-sm text-gray-500 dark:text-gray-600 leading-relaxed font-medium uppercase tracking-widest">
                   Private VPC Cluster · Brand DNA Locking · Zero-Retention Storage · SOC2 Compliant
                 </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            <h3 className="text-[10px] font-black uppercase text-brand-blue tracking-[0.4em] mb-6">Studio_Manifest</h3>
            <div className="space-y-4">
              {[
                { title: "Deterministic Motion", desc: "Lock camera behavior to industrial precision." },
                { title: "Identity Persistence", desc: "Maintain product visual DNA across takes." },
                { title: "Parallel Rendering", desc: "Synthesize 1080p takes in under 2 minutes." },
                { title: "Production Pipeline", desc: "Native export to Premiere, Resolve, and FCPX." }
              ].map(f => (
        ...
        <section className="mb-32 py-20 border-y border-black/10 dark:border-white/5">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="max-w-xl space-y-6 text-center lg:text-left">
              ...
              <p className="text-gray-500 dark:text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-widest">Proprietary orchestration of industrial commercial models.</p>
            </div>
        ...
        <section className="mb-32">
          <div className="flex justify-between items-end mb-12">
            <div className="space-y-2">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic">Studio_Gallery</h2>
              <p className="text-[10px] font-black uppercase text-gray-400 dark:text-gray-700 tracking-[0.4em]">Optimized Output // Brand-Verified Synthesis</p>
            </div>
            ...
            {showcaseVideos.map((img, i) => (
              ...
              >
                ...
                <div className="absolute bottom-8 left-8 space-y-3 translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                   ...
                   <h4 className="text-2xl font-black uppercase text-white tracking-tighter leading-none">Studio_Verified</h4>
                </div>
              </div>
            ))}
          </div>
           ...
           <div className="bg-gradient-to-br from-brand-blue/10 to-transparent border border-brand-blue/20 p-12 lg:p-24 relative overflow-hidden group rounded-sm shadow-xl">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                 <div className="space-y-8 max-w-2xl text-center lg:text-left">
                    <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.8] text-black dark:text-white">Scale Your <br /> <span className="text-brand-blue italic">Brand Studio.</span></h2>
                    <p className="text-gray-600 dark:text-gray-500 text-lg leading-relaxed font-medium">
                       Deploy a dedicated Nexus Studio Node for your marketing team. 1080p high-fidelity synthesis with full brand-DNA logic and VPC security.
                    </p>
                 </div>
