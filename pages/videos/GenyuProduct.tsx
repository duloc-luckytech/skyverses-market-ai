...
const GenyuProduct = () => {
  ...
  return (
    <div className="pt-24 bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-black dark:text-white font-sans overflow-x-hidden selection:bg-brand-blue/30 transition-colors duration-500 pb-32">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div className="lg:col-span-7 space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000">
              <div className="space-y-10">
                <Link to="/" className="inline-flex items-center gap-3 px-6 py-2 border border-black/10 dark:border-white/10 text-gray-500 hover:text-brand-blue transition-all group rounded-full bg-white/50 dark:bg-transparent backdrop-blur-md shadow-sm">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.4em]">{t('nav.browse')} Repository</span>
                </Link>

                <div className="space-y-6">
                   <div className="flex items-center gap-4 text-brand-blue">
                      <Clapperboard size={32} />
                      <span className="text-[14px] font-bold uppercase tracking-[0.8em] opacity-60 italic">ARCHITECT SUITE V1.4</span>
                   </div>
                   <h1 className="text-6xl lg:text-[120px] font-bold uppercase tracking-tighter leading-[0.75] italic">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                 ...
                 <div className="flex flex-col justify-center px-4 border-l border-black/10 dark:border-white/10">
                    ...
                    <p className="text-xs text-gray-500 uppercase tracking-widest font-bold">Professional Inference Node</p>
                 </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 w-full">
               <div className="aspect-[4/5] bg-gray-100 dark:bg-[var(--atlas-bg-page)] border border-black/5 dark:border-white/[0.06] relative overflow-hidden shadow-atlas-lg rounded-sm group">
                  ...
                  <div className="absolute bottom-10 left-10 space-y-2">
                     <p className="text-[10px] font-bold uppercase text-brand-blue tracking-[0.5em]">Scene System v1.0</p>
                     <h3 className="text-3xl font-bold italic text-black dark:text-white leading-tight uppercase tracking-tighter">Deterministic Control.</h3>
                  </div>
               </div>
            </div>
          </div>
                ...
                { step: '04', title: 'Master', icon: <Crown />, desc: 'Upscale, assemble, and export studio-ready 4K sequences.' }
                 ...
                 <div key={item.step} className="p-10 bg-black/[0.02] dark:bg-white/[0.01] border border-black/5 dark:border-white/[0.06] rounded-sm space-y-6 group hover:border-brand-blue/30 transition-all">
                    ...
                    <div className="space-y-2">
                       <h4 className="text-lg font-bold uppercase tracking-tight italic">{item.title}</h4>
        ...
        <section className="py-32 grid grid-cols-1 lg:grid-cols-2 gap-24 items-center border-t border-black/5 dark:border-white/[0.06]">
           <div className="space-y-12">
              <div className="space-y-6">
                 ...
                 <p className="text-gray-400 dark:text-gray-500 uppercase text-[10px] font-bold tracking-[0.5em]">SYSTEM VERSION 1.4.0 STABLE</p>
              </div>
                   ...
                   { l: 'Data Retention', v: 'Zero-Trace (Non-Training)', icon: <Shield size={14}/> }
                    ...
                    <div key={stat.l} className="flex justify-between items-center border-b border-black/5 dark:border-white/10 pb-4 group">
                       <div className="flex items-center gap-3">
                          ...
                          <span className="text-[11px] font-bold uppercase text-gray-500 group-hover:text-brand-blue transition-colors tracking-widest">{stat.l}</span>
                       </div>
                       <span className="text-sm font-bold uppercase italic">{stat.v}</span>
                    </div>
                 ))}
              </div>
           </div>
           <div className="p-16 border border-black/10 dark:border-white/10 bg-black shadow-atlas-lg relative overflow-hidden group rounded-sm">
              ...
              <div className="space-y-4 relative z-10">
                 <h3 className="text-4xl font-bold uppercase italic tracking-tighter">B2B Compliance.</h3>
        ...
        <section className="py-60 text-center relative overflow-hidden">
           ...
           <div className="space-y-12 relative z-10 max-w-4xl mx-auto">
              <h2 className="text-8xl lg:text-[180px] font-bold uppercase tracking-tighter leading-[0.8] italic text-black dark:text-white">
