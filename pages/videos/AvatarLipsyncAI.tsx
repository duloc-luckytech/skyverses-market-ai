...
const AvatarLipsyncAI = () => {
  ...
  return (
    <div className="bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-slate-900 dark:text-white font-sans selection:bg-violet-500/30 overflow-x-hidden pt-20 transition-colors duration-500">
      ...
      <section className="min-h-[90vh] flex flex-col justify-center px-6 lg:px-12 py-20 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-600 dark:text-violet-400 text-[10px] font-bold uppercase tracking-[0.3em] italic">
            ...
            <div className="relative aspect-video bg-white dark:bg-[var(--atlas-bg-page)] border border-slate-200 dark:border-white/10 rounded-xl p-4 shadow-atlas-xl overflow-hidden group">
               ...
               <div className="h-full w-full bg-black rounded-lg border border-slate-200 dark:border-white/[0.06] overflow-hidden relative">
                  ...
                  <div className="absolute top-6 left-6 flex items-center gap-3 bg-black/40 backdrop-blur-md px-3 py-1 rounded-full border border-white/10">
                     ...
                     <span className="text-[8px] font-bold uppercase text-white tracking-widest">Rendering_Alpha_v1.2</span>
                  </div>

                  <div className="absolute bottom-6 left-6 right-6 flex justify-between items-end">
                     <div className="space-y-1">
                        <p className="text-[9px] font-bold uppercase text-violet-400 tracking-widest italic">Lipsync_Sync: OK</p>
      ...
      <section className="py-40 border-y border-slate-200 dark:border-white/[0.06] relative bg-slate-50 dark:bg-[var(--atlas-bg-page)] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center space-y-4 mb-24">
             ...
             <p className="text-slate-500 dark:text-gray-500 uppercase text-[10px] font-bold tracking-[0.5em]">Simple Steps // Complex Neural Synthesis</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="p-12 bg-white dark:bg-white/[0.06] border border-slate-200 dark:border-white/10 rounded-sm relative group overflow-hidden hover:border-violet-500/30 transition-all shadow-sm dark:shadow-atlas-lg">
                ...
                <h4 className="text-2xl font-bold uppercase italic tracking-tight mb-4 text-slate-900 dark:text-white">{s.title}</h4>
         ...
         <div className="max-w-7xl mx-auto px-6 lg:px-12 space-y-24 relative z-10">
            <div className="flex flex-col md:flex-row justify-between items-end gap-8">
              <div className="space-y-4">
                 <h2 className="text-5xl lg:text-[100px] font-bold uppercase tracking-tighter italic leading-none text-slate-900 dark:text-white">Animate Every <br /><span className="text-violet-600 dark:text-violet-500">Narrative.</span></h2>
              </div>
      ...
      <section className="py-40 bg-white dark:bg-black transition-colors">
         <div className="max-w-4xl mx-auto px-6 text-center space-y-16">
            <h2 className="text-4xl lg:text-6xl font-bold uppercase italic tracking-tighter text-slate-900 dark:text-white">Why Avatar Lipsync AI?</h2>
      ...
      <section className="py-60 text-center relative overflow-hidden bg-slate-50 dark:bg-black border-t border-slate-200 dark:border-white/[0.06] transition-colors">
        ...
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
           <h2 className="text-7xl lg:text-[140px] font-bold uppercase tracking-tighter leading-[0.8] italic text-slate-900 dark:text-white transition-colors">Animate Your <br /> <span className="text-violet-600 dark:text-violet-500">Identity.</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-12 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-gray-500">
           <div className="flex flex-col items-center md:items-start gap-4">
              <div className="flex items-center gap-4">
                 <span className="text-slate-900 dark:text-white text-lg tracking-tighter italic font-bold uppercase transition-colors">Avatar Lipsync AI</span>
              </div>
