...
const AIVideoGenerator: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-slate-900 dark:text-white font-sans selection:bg-indigo-500/30 overflow-x-hidden pt-16 transition-colors duration-300">
