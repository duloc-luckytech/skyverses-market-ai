      ...
      <div className="max-w-[1700px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <section className="min-h-[70vh] flex flex-col justify-center py-12 lg:py-20 text-center">
          <div className="max-w-5xl mx-auto space-y-12">
            <Link to="/" className="inline-flex items-center gap-3 px-6 py-2 border border-black/10 dark:border-white/10 text-gray-500 hover:text-emerald-500 transition-all rounded-full bg-white/50 dark:bg-transparent backdrop-blur-md shadow-sm w-fit mx-auto">
              ...
              <span className="text-[10px] font-bold uppercase tracking-[0.4em]">Back_To_Market</span>
            </Link>
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-8 justify-center items-center">
               <button 
                 ...
                 className="w-full sm:w-auto bg-emerald-500 text-black px-20 py-8 text-[13px] font-bold uppercase tracking-[0.4em] shadow-[0_30px_90px_rgba(16,185,129,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-6 rounded-sm group relative overflow-hidden"
               >
                  <div className="absolute inset-0 bg-white/20 -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                  Bắt đầu sáng tạo <Play size={20} fill="currentColor" />
               </button>
               <button className="px-12 py-8 border border-black/10 dark:border-white/10 rounded-sm text-[11px] font-bold uppercase tracking-[0.3em] hover:bg-black dark:hover:bg-white dark:hover:text-black transition-all italic">
        ...
        <section className="py-24 border-t border-black/5 dark:border-white/[0.06] space-y-16">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-4">
               <div className="flex items-center gap-3 text-emerald-500">
                  <LayoutGrid size={24} />
                  <h2 className="text-3xl lg:text-5xl font-bold uppercase tracking-tighter italic text-slate-900 dark:text-white">Thư viện <span className="text-emerald-500">Kịch bản.</span></h2>
               </div>
              ...
              >
                ...
                <div className="absolute top-6 left-6">
                   <div className="flex items-center gap-2 px-3 py-1 bg-black/40 backdrop-blur-md border border-white/10 rounded-full">
                      ...
                      <span className="text-[8px] font-bold text-white uppercase tracking-widest">Active_Node</span>
                   </div>
                </div>

                <div className="absolute bottom-8 left-8 right-8 space-y-3">
                   <h4 className="text-2xl font-bold uppercase italic tracking-tighter text-white leading-tight">{tmpl.name}</h4>
          ...
          <div className="flex justify-center pt-10">
             <button className="px-16 py-6 border border-black/10 dark:border-white/10 rounded-full text-[11px] font-bold uppercase tracking-[0.4em] hover:bg-emerald-500 hover:text-white transition-all italic">
             ...
             <div className="lg:col-span-4 space-y-10">
                <div className="space-y-6">
                   <div className="flex items-center gap-4 text-emerald-500">
                      <Code2 size={28} />
                      <span className="text-[11px] font-bold uppercase tracking-[0.6em] italic">Creative_Grid_v2.0</span>
                   </div>
                   <h2 className="text-5xl lg:text-8xl font-bold uppercase tracking-tighter italic leading-none text-slate-900 dark:text-white">Phòng Lab <br /> <span className="text-emerald-500">Sáng tạo.</span></h2>
                </div>
             ...
             <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-px bg-black/[0.06] dark:bg-white/[0.06] border border-black/5 dark:border-white/[0.06] shadow-atlas-lg rounded-sm overflow-hidden">
                {[
                  ...
                  <div key={item.step} className="p-16 bg-white dark:bg-[var(--atlas-bg-page)] space-y-10 group hover:bg-emerald-500/[0.01] transition-all duration-700 border-r border-black/5 dark:border-white/[0.06] last:border-r-0">
                    ...
                    <div className="space-y-4">
                       <h4 className="text-2xl font-bold uppercase tracking-tighter italic text-slate-900 dark:text-white">{item.label}</h4>
