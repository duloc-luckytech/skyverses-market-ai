      ...
      <div className="max-w-[1700px] mx-auto px-6 lg:px-20 py-12 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
            <div className="space-y-10">
               <div className="flex items-center gap-4 text-brand-blue">
                  ...
                  <span className="text-xs font-bold uppercase tracking-[0.5em]">LOGIC_GATES_ACTIVE</span>
               </div>
               <h2 className="text-6xl font-bold uppercase tracking-tighter leading-none">Technical <br /> Mastery.</h2>
        ...
        <section className="py-60 text-center">
          <div className="max-w-4xl mx-auto space-y-16">
            <h2 className="text-7xl md:text-[140px] font-bold uppercase tracking-tighter leading-[0.8] text-white">
