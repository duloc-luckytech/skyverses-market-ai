...
const ProductUniversalProducer = () => {
  ...
  return (
    <div className="pt-24 bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-black dark:text-white font-sans selection:bg-brand-blue/30 overflow-x-hidden transition-colors duration-500">
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-20">
          <div className="space-y-6">
            <Link to="/market" className="inline-flex items-center gap-2 text-[10px] font-bold uppercase text-gray-400 dark:text-gray-600 hover:text-brand-blue transition-colors tracking-[0.4em]">
              <ChevronLeft size={14} /> BACK_TO_REPOSITORY
            </Link>
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-6 mb-4">
                <h1 className="text-5xl lg:text-8xl font-bold uppercase tracking-tighter italic leading-[0.8]">{solution.name[lang]}</h1>
                <div className="px-4 py-1.5 bg-brand-blue/10 border border-brand-blue/30 rounded-sm w-fit shrink-0">
                   <span className="text-[10px] font-bold text-brand-blue uppercase tracking-widest">Ultra_Infrastructure</span>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-8">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[11px] font-bold text-gray-400 dark:text-white/40 uppercase tracking-widest">5.0 (CLASS_S_VERIFIED)</span>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-12">
                 <div className="max-w-4xl space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-1000">
                    ...
                    <div className="space-y-4">
                       <h2 className="text-5xl lg:text-7xl font-bold uppercase tracking-tighter leading-[0.9] italic text-black dark:text-white">Unify the <br /> <span className="text-brand-blue">Production Graph.</span></h2>
                       <p className="text-gray-600 dark:text-gray-500 text-sm md:text-base uppercase font-bold tracking-[0.4em]">Cross-Domain Neural Production Infrastructure</p>
                    </div>
                    <button 
        ...
        <section className="mb-40 grid grid-cols-1 lg:grid-cols-12 gap-24 items-start">
          <div className="lg:col-span-8 space-y-16">
            <div className="space-y-8">
              <h2 className="text-5xl font-bold uppercase tracking-tighter italic flex items-center gap-6">
          ...
          <div className="lg:col-span-4 space-y-12">
            <h3 className="text-[12px] font-bold uppercase text-brand-blue tracking-[0.5em] border-b border-brand-blue/20 pb-4">Studio_Manifest_v4.2</h3>
            <div className="space-y-6">
              {[
        ...
        <section className="mb-40 py-24 border-y border-black/10 dark:border-white/[0.06] relative">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-16 relative z-10">
            <div className="max-w-2xl space-y-8 text-center lg:text-left">
              <h2 className="text-4xl lg:text-6xl font-bold uppercase tracking-tighter italic">Collaborative <br /> <span className="text-brand-blue">Intelligence.</span></h2>
           ...
           <div className="bg-gradient-to-br from-brand-blue/20 to-transparent border border-brand-blue/30 p-16 lg:p-32 relative overflow-hidden group rounded-sm shadow-atlas-lg">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-24">
                 <div className="space-y-10 max-w-3xl text-center lg:text-left">
                    <h2 className="text-6xl lg:text-9xl font-bold uppercase tracking-tighter leading-[0.8] text-black dark:text-white italic">Unify Your <br /> <span className="text-brand-blue">Global Hub.</span></h2>
