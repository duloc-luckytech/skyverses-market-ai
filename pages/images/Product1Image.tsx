...
import NebulaDemoInterface from '../../components/NebulaDemoInterface';
import { 
...
const Product1Image = () => {
  ...
  const showcaseImages = [
    { url: "https://images.unsplash.com/photo-1620641788421-7a1c342ea42e?auto=format&fit=crop&q=80&w=1200", label: "PHASE_01: CONCEPT_SYNTHESIS" },
    { url: "https://images.unsplash.com/photo-1614850523296-d8c1af93d400?auto=format&fit=crop&q=80&w=1200", label: "PHASE_02: MATERIAL_STUDY" },
    { url: "https://images.unsplash.com/photo-1635236066249-724441e62102?auto=format&fit=crop&q=80&w=1200", label: "PHASE_03: LIGHTING_PHYSICS" },
    { url: "https://images.unsplash.com/photo-1542751371-adc38448a05e?auto=format&fit=crop&q=80&w=1200", label: "PHASE_04: VOLUMETRIC_DEPTH" },
    { url: "https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&q=80&w=1200", label: "PHASE_05: ATMOSPHERIC_HUD" }
  ];
        ...
        <div className="fixed inset-0 z-[250] bg-white/98 dark:bg-black/98 flex flex-col animate-in fade-in duration-300">
          <div className="h-16 border-b border-black/10 dark:border-white/5 bg-white/80 dark:bg-black/80 backdrop-blur-xl flex items-center justify-between px-8 shrink-0">
             <div className="flex items-center gap-4">
                ...
                <span className="text-[11px] font-black uppercase tracking-[0.4em] text-gray-600 dark:text-white/70">Nebula_Lab // Vision_Engine_v7.0</span>
             </div>
      ...
      <div className="max-w-[1500px] mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-2">
                ...
                <div className="px-3 py-1 bg-brand-blue/10 border border-brand-blue/30 rounded-sm w-fit">
                   <span className="text-[9px] font-black text-brand-blue uppercase tracking-widest">Vision_Class_S</span>
                </div>
              </div>
              <p className="text-gray-500 dark:text-gray-400 text-xl font-medium max-w-2xl leading-relaxed italic">"The definitive architectural synthesis platform for creative professionals."</p>
            </div>
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[11px] font-black text-gray-400 dark:text-white/40 uppercase tracking-widest">4.9 (8,240 REQUESTS_LOGGED)</span>
              </div>
              <div className="flex items-center gap-3">
                 <div className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></div>
                 <span className="text-[10px] font-bold text-gray-400 dark:text-gray-700 uppercase tracking-widest">{solution.category[lang]} Active</span>
              </div>
            </div>
          </div>
        ...
        <section className="mb-24 relative group">
           <div className="aspect-[21/9] w-full bg-gray-100 dark:bg-[#080808] border border-black/5 dark:border-white/5 overflow-hidden relative shadow-2xl rounded-sm">
              <img src={solution.imageUrl} className="w-full h-full object-cover grayscale opacity-40 group-hover:opacity-60 transition-all duration-1000 group-hover:scale-105" alt="Nebula Hub" />
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
                 <div className="max-w-2xl space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                    ...
                    <div className="space-y-4">
                       <h2 className="text-4xl lg:text-5xl font-black uppercase tracking-tighter leading-none italic text-black dark:text-white">Orchestrate the <br /> <span className="text-brand-blue">Vision Core</span></h2>
                       <p className="text-gray-600 dark:text-gray-500 text-sm uppercase font-black tracking-widest">Multi-stage architectural synthesis sandbox</p>
                    </div>
                    <button 
                    ...
                    >
                      Access_Vision_Node <Play size={16} className="fill-current group-hover/btn:translate-x-1 transition-transform" />
                    </button>
                 </div>
              </div>
              ...
              <div className="absolute bottom-8 left-8 flex items-center gap-4 px-4 py-2 bg-white/40 dark:bg-black/40 backdrop-blur-md border border-black/10 dark:border-white/10 rounded-sm">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-widest text-gray-700 dark:text-white/60 italic">Interactive_Sandbox_v7.0 Ready</span>
              </div>
           </div>
        </section>
        ...
        <section className="mb-32 grid grid-cols-1 lg:grid-cols-12 gap-20">
          <div className="lg:col-span-8 space-y-12">
            <div className="space-y-6">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic flex items-center gap-4">
                <div className="w-12 h-[2px] bg-brand-blue"></div> Engineering_Philosophy
              </h2>
              <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed font-medium">
                Nebula Vision Engine is a professional-grade architectural synthesis platform. Unlike standard generative models, it is engineered for volumetric accuracy and deterministic lighting control. It empowers directors and architects to iterate on spatial concepts with the speed of neural inference while maintaining the fidelity of offline rendering.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 rounded-sm">
                 ...
                 <ul className="space-y-3">
                   {["Luxury real-estate visualization.", "Studio-grade product staging.", "Environment design for AAA film.", "Automated retail asset generation."].map(item => (
              ...
              <div className="p-8 border border-black/5 dark:border-white/5 bg-gray-50 dark:bg-white/[0.01] space-y-4 flex flex-col justify-center rounded-sm">
                 ...
                 <h3 className="text-xl font-black uppercase tracking-tighter">Authorized_Personnel</h3>
                 <p className="text-sm text-gray-500 dark:text-gray-600 leading-relaxed font-medium uppercase tracking-widest">
                   Lead Architects · Art Directors · Pipeline Engineers · Creative Agencies
                 </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="space-y-4">
              {[
                { title: "8K Matrix Render", desc: "Native high-resolution output for print and film." },
                { title: "Volumetric Physics", desc: "Realistic ray-tracing for light and shadow dynamics." },
                { title: "Material DNA", desc: "Consistent texture mapping across multi-frame synthesis." },
                { title: "Low-Latency Sync", desc: "Real-time directive parsing via neural edge nodes." }
              ].map(f => (
        ...
        <section className="mb-32 py-20 border-y border-black/10 dark:border-white/5">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-12">
            <div className="max-w-xl space-y-6 text-center lg:text-left">
              <h2 className="text-3xl font-black uppercase tracking-tighter">AI_Orchestration</h2>
              <p className="text-gray-500 dark:text-gray-600 text-sm font-medium leading-relaxed uppercase tracking-widest">Multi-modal orchestration of leading foundation models.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-grow">
               {[
                 { name: "Gemini 2.5 Flash", role: "Directive Analysis", status: "Active" },
                 { name: "SDXL Nexus", role: "Synthesis Layer", status: "Optimized" },
                 { name: "Nebula Upscaler", role: "Matrix Reconstruction", status: "8K_Ready" }
               ].map(m => (
        ...
        <section className="mb-32">
          <div className="flex justify-between items-end mb-12">
            <div className="space-y-2">
              <h2 className="text-4xl font-black uppercase tracking-tighter italic">Production_Gallery</h2>
              <p className="text-[10px] font-black uppercase text-gray-400 dark:text-gray-700 tracking-[0.4em]">Validation Frames // Zero-Artifact Synthesis</p>
            </div>
          ...
          <div className="max-w-3xl mx-auto space-y-12">
            <div className="text-center space-y-4">
               <h2 className="text-4xl font-black uppercase tracking-tighter flex items-center justify-center gap-6 text-black dark:text-white">
                  <div className="w-12 h-px bg-red-500/50"></div> Report_An_Incident <div className="w-12 h-px bg-red-500/50"></div>
               </h2>
               <p className="text-gray-500 dark:text-gray-500 text-[10px] font-black uppercase tracking-[0.4em]">Help refine the Vision Core weights</p>
            </div>

            <form onSubmit={(e) => { e.preventDefault(); setReportForm(false); alert('Audit Logged.'); }} className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                 <label className="text-[10px] font-black uppercase text-gray-400 dark:text-gray-700 tracking-widest">Incident_Category</label>
                 <select value={reportType} onChange={(e) => setReportType(e.target.value)} className="w-full bg-white dark:bg-white/5 border border-black/10 dark:border-white/10 p-5 text-[11px] font-black uppercase text-black dark:text-white outline-none focus:border-red-500 transition-all appearance-none rounded-none">
                    ...
                    <option value="output">Visual Artifacts</option>
                    <option value="latency">High Synthesis Latency</option>
                 </select>
              </div>
              <div className="space-y-4">
                 <label className="text-[10px] font-black uppercase text-gray-400 dark:text-gray-700 tracking-widest">Support_Email</label>
                 <input type="email" placeholder="ADMIN@YOURSTUDIO.COM" className="w-full bg-white/5 border border-black/10 dark:border-white/10 p-5 text-[11px] font-black uppercase text-black dark:text-white outline-none focus:border-brand-blue" />
              </div>
              <div className="md:col-span-2 space-y-4">
                 <label className="text-[10px] font-black uppercase text-gray-400 dark:text-gray-700 tracking-widest">Incident_Description</label>
              ...
              <div className="md:col-span-2 flex flex-col sm:flex-row justify-between items-center gap-8 pt-4">
                 <div className="flex items-center gap-4 text-gray-400 dark:text-gray-600">
                    <ShieldCheck size={14} />
                    <span className="text-[8px] font-black uppercase tracking-widest">Node_Telemetry_Attached</span>
                 </div>
           ...
           <div className="bg-gradient-to-br from-brand-blue/10 to-transparent border border-brand-blue/20 p-12 lg:p-24 relative overflow-hidden group rounded-sm shadow-xl">
              ...
              <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-16">
                 <div className="space-y-8 max-w-2xl text-center lg:text-left">
                    <h2 className="text-5xl lg:text-7xl font-black uppercase tracking-tighter leading-[0.8] text-black dark:text-white">Start Your <br /> <span className="text-brand-blue italic">First Build.</span></h2>
                    <p className="text-gray-600 dark:text-gray-500 text-lg leading-relaxed font-medium">
                       Deploy a dedicated Nebula Node on your internal infrastructure. 8K synthesis at the speed of thought, with complete VPC isolation.
                    </p>
                 </div>
                 <div className="flex flex-col sm:flex-row gap-6 w-full lg:w-auto">
                    <Link to="/booking" className="btn-sky-primary px-16 py-8 text-[11px] uppercase tracking-[0.4em] text-center shadow-2xl transition-all">Book_Architecture_Session</Link>
                    <Link to="/booking" className="btn-sky-secondary px-16 py-8 text-[11px] uppercase tracking-[0.4em] text-center border border-black/10 dark:border-white/20 hover:border-brand-blue/50 text-black dark:text-white">Request_Whitepaper</Link>
                 </div>
              </div>
           </div>
        </section>
