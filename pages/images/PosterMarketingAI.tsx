    ...
    <div className="bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-slate-900 dark:text-white font-sans selection:bg-brand-blue/30 overflow-x-hidden pt-20 transition-colors duration-500">
      ...
      <section className="min-h-screen flex flex-col justify-center px-6 lg:px-12 py-20 relative">
        ...
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center relative z-10">
          <div className="lg:col-span-5 space-y-10">
            <Link to="/market" className="inline-flex items-center gap-2 text-[10px] font-bold uppercase text-slate-500 dark:text-gray-500 hover:text-brand-blue transition-colors tracking-[0.4em]">
              <ChevronLeft size={14} /> Back to Repository
            </Link>
            <div className="space-y-6">
              <h1 className="text-6xl lg:text-[90px] font-bold leading-[0.85] tracking-tighter italic uppercase text-slate-900 dark:text-white">
                ...
                <div className="flex h-full gap-4">
                   ...
                   <div className="flex-grow bg-slate-50 dark:bg-black rounded-sm border border-brand-blue/10 dark:border-brand-blue/20 relative overflow-hidden flex items-center justify-center transition-colors">
                      ...
                      <div className="absolute bottom-8 left-8">
                         <h3 className="text-4xl font-bold italic uppercase tracking-tighter leading-none text-white">HIGH CONVERSION</h3>
                         <p className="text-[10px] font-bold text-brand-blue uppercase tracking-[0.4em] mt-2">Neural_Blueprint_v1</p>
                      </div>
      ...
      <section className="py-40 bg-slate-50 dark:bg-[var(--atlas-bg-page)] border-y border-slate-200 dark:border-white/[0.06] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center space-y-4 mb-24">
             ...
             <p className="text-slate-400 dark:text-gray-500 uppercase text-[10px] font-bold tracking-[0.5em]">01 → 02 → 03 Workflow</p>
          </div>
         ...
         <div className="max-w-7xl mx-auto px-6 lg:px-12">
           <div className="flex justify-between items-end mb-24">
              <div className="space-y-4">
                 <h2 className="text-5xl lg:text-7xl font-bold uppercase tracking-tighter italic leading-none text-slate-900 dark:text-white">Market Every <br /><span className="text-brand-blue">Frontier.</span></h2>
              </div>
           </div>
                ...
                <div key={i} className="group relative overflow-hidden aspect-[4/5] border border-slate-100 dark:border-white/[0.06] rounded-sm bg-slate-200 dark:bg-black transition-colors">
                   ...
                   <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent p-10 flex flex-col justify-end">
                      <div className="space-y-4 translate-y-4 group-hover:translate-y-0 transition-transform">
                         ...
                         <p className="text-xs text-brand-blue font-bold uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">"{item.d}"</p>
                      </div>
                   </div>
                </div>
              ))}
      ...
      <section className="py-60 text-center relative overflow-hidden bg-slate-50 dark:bg-black border-t border-slate-200 dark:border-white/[0.06] transition-colors">
        ...
        <div className="max-w-4xl mx-auto space-y-16 relative z-10">
          <h2 className="text-8xl lg:text-[150px] font-bold uppercase tracking-tighter leading-[0.8] italic text-slate-900 dark:text-white">Turn Ideas <br /> Into <span className="text-brand-blue">Growth.</span></h2>
      ...
      <footer className="py-20 border-t border-slate-200 dark:border-white/[0.06] bg-white dark:bg-[var(--atlas-bg-page)] transition-colors">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row justify-between items-center gap-12 text-[10px] font-bold uppercase tracking-widest text-slate-400 dark:text-gray-500">
           <div className="flex flex-col items-center md:items-start gap-4">
              <div className="flex items-center gap-4">
                 <span className="text-slate-900 dark:text-white text-lg tracking-tighter italic font-bold">POSTER MARKETING AI</span>
              </div>
