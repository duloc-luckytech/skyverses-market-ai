...
const RealEstateAI: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-slate-900 dark:text-white font-sans selection:bg-purple-500/30 overflow-x-hidden pt-20 transition-colors duration-500">
        ...
        <div className="max-w-[1500px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center relative z-10">
          <div className="lg:col-span-6 space-y-10 order-2 lg:order-1">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-600 dark:text-purple-400 text-[10px] font-bold uppercase tracking-[0.2em]"
            >
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4">
              <button 
                ...
                className="bg-purple-600 text-white px-12 py-6 rounded-sm text-xs font-bold uppercase tracking-[0.4em] shadow-[0_20px_80px_rgba(168,85,247,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4 group"
              >
             ...
             <div className="aspect-[4/3] bg-slate-50 dark:bg-[var(--atlas-bg-page)] border border-slate-200 dark:border-white/5 rounded-[2rem] p-4 shadow-3xl relative overflow-hidden transition-colors flex flex-col justify-center items-center group">
                ...
                <div className="relative z-10 w-full h-full rounded-2xl overflow-hidden shadow-2xl border border-white dark:border-white/10">
                   ...
                   <div className="absolute bottom-6 left-6 right-6 p-4 bg-black/60 backdrop-blur-md border border-white/10 rounded-xl">
                      <p className="text-[10px] font-bold uppercase tracking-widest text-purple-400 mb-1">Active Renovation</p>
                      <h4 className="text-xl font-bold uppercase italic leading-none">VIRTUAL_STAGING_v4.2</h4>
                   </div>
                </div>
             </div>
          </div>
            ...
            {[
              ...
              <div key={i} className="p-16 bg-white dark:bg-black space-y-8 group hover:bg-purple-500/[0.02] transition-all duration-500 border-r border-slate-50 dark:border-white/5 last:border-r-0">
                 ...
                 <div className="space-y-3">
                    <h4 className="text-2xl font-bold uppercase tracking-tighter italic text-slate-900 dark:text-white transition-colors">{f.t}</h4>
      ...
      <section className="py-60 text-center relative overflow-hidden bg-white dark:bg-black transition-colors">
        ...
        <div className="max-w-4xl mx-auto space-y-16 relative z-10 px-6">
           <h2 className="text-7xl lg:text-[140px] font-bold uppercase tracking-tighter leading-[0.8] italic text-slate-900 dark:text-white transition-colors">Thiết lập <br /> <span className="text-purple-600 dark:text-purple-500">Tương lai.</span></h2>
           <button onClick={() => setIsStudioOpen(true)} className="bg-slate-900 dark:bg-white text-white dark:text-black px-24 py-8 rounded-full text-sm font-bold uppercase tracking-[0.6em] shadow-[0_40px_100px_rgba(168,85,247,0.2)] hover:scale-110 active:scale-95 transition-all flex items-center gap-6 mx-auto group">
