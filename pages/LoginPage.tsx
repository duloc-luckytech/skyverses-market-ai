      ...
      <motion.button
        ...
        style={{
          background: isSelected
            ? 'linear-gradient(135deg, rgba(112,54,240,0.08), rgba(112,54,240,0.02))'
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row overflow-hidden relative" style={{ background: '#08080c' }}>
      ...
      <style>{`
        ...
        @keyframes pulseRing {
          0% { box-shadow: 0 0 0 0 rgba(112,54,240,0.4); }
          70% { box-shadow: 0 0 0 12px rgba(112,54,240,0); }
          100% { box-shadow: 0 0 0 0 rgba(112,54,240,0); }
        }
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden z-0">
        <div className="login-mesh-1 absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full opacity-30"
          style={{ background: 'radial-gradient(circle, rgba(112,54,240,0.15) 0%, transparent 70%)' }} />
      ...
      {onboardingStep > 0 && (
        <div className="lg:hidden fixed top-0 left-0 right-0 h-1 z-[100]" style={{ background: 'rgba(255,255,255,0.03)' }}>
          <motion.div
            ...
            style={{ background: 'linear-gradient(90deg, #7036F0, #7c3aed)' }}
                ...
                <motion.div key="login" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.35 }} className="space-y-8">
                    ...
                    <div>
                      ...
                      >
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-[0.2em]"
                          style={{
                            background: 'linear-gradient(90deg, rgba(112,54,240,0.12), rgba(139,92,246,0.08))',
                            border: '1px solid rgba(112,54,240,0.2)',
                            color: '#7036F0'
                          }}
                        >
                  ...
                  >
                    <button
                      ...
                      onMouseEnter={e => {
                        (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(112,54,240,0.3)';
                        (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 4px 24px rgba(112,54,240,0.1)';
                      }}
                      onMouseLeave={e => {
                  ...
                  <motion.button
                    ...
                    style={{
                      background: isNextDisabled()
                        ...
                        : 'linear-gradient(135deg, #7036F0, #0070cc)',
                      color: 'white',
                      boxShadow: isNextDisabled() ? 'none' : '0 8px 32px rgba(112,54,240,0.25)',
                    }}
                  >
          ...
          <div className="space-y-5 max-w-lg">
            ...
            >
              ...
              <h2 className="text-4xl lg:text-[44px] font-bold text-white leading-[1.08] tracking-tight">
                ...
                <br />
                <span style={{
                  background: 'linear-gradient(90deg, #7036F0, #7c3aed, #ec4899)',
                  backgroundSize: '200% auto',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                  backgroundClip: 'text',
                ...
                <motion.div
                  ...
                  style={{
                    background: i === loginImageIndex
                      ? 'linear-gradient(90deg, #7036F0, #7c3aed)'
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  style={{
                    border: '2px solid rgba(112,54,240,0.15)',
                    animation: 'pulseRing 2s ease-in-out infinite',
                  }}
                />
                <div className="absolute -inset-8 rounded-[2rem] opacity-20"
                  style={{ background: 'radial-gradient(circle, rgba(112,54,240,0.3) 0%, transparent 70%)' }} />
              </div>
