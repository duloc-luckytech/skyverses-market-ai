...
const ProductGame1 = () => {
  ...
  return (
    <div className="pt-24 bg-white dark:bg-[var(--atlas-bg-page)] min-h-screen text-black dark:text-white font-sans overflow-x-hidden selection:bg-emerald-500/30 transition-colors duration-500 pb-32">
            ...
            <div className="lg:col-span-7 space-y-12 animate-in fade-in slide-in-from-left-8 duration-1000">
              <div className="space-y-10">
                <Link to="/" className="inline-flex items-center gap-3 px-6 py-2 border border-black/10 dark:border-white/10 text-gray-500 hover:text-emerald-500 transition-all group rounded-full">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-[0.4em]">Back to Marketplace</span>
                </Link>

                <div className="space-y-6">
                   <div className="flex items-center gap-4 text-emerald-500">
                      <BrainCircuit size={32} />
                      <span className="text-[14px] font-bold uppercase tracking-[0.8em] opacity-60 italic">NEURAL_GAME_ARCH_V1</span>
                   </div>
                   <h1 className="text-7xl lg:text-[120px] font-bold uppercase tracking-tighter leading-[0.75] italic">
              ...
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                 <button onClick={() => setIsStudioOpen(true)} className="bg-emerald-500 text-white px-16 py-8 text-[12px] font-bold uppercase tracking-[0.4em] shadow-[0_20px_80px_rgba(16,185,129,0.3)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-6 rounded-sm group relative overflow-hidden">
                 ...
                 <div className="flex flex-col justify-center px-4 border-l border-black/10 dark:border-white/10">
                    ...
                    <p className="text-xs text-gray-500 uppercase tracking-widest font-bold">Procedural Logic Synthesis</p>
                 </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 w-full">
               <div className="aspect-[4/5] bg-gray-100 dark:bg-[var(--atlas-bg-page)] border border-black/5 dark:border-white/[0.06] relative overflow-hidden shadow-atlas-lg rounded-sm group">
                  ...
                  <div className="absolute bottom-10 left-10 space-y-2">
                     <p className="text-[10px] font-bold uppercase text-emerald-500 tracking-[0.5em]">World_Engine_v1.0</p>
                     <h3 className="text-3xl font-bold italic text-black dark:text-white leading-tight uppercase tracking-tighter">Procedural Logic.</h3>
                  </div>
               </div>
            </div>
          </div>
